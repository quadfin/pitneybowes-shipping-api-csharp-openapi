...
namespace shippingapi.Api
{
    ...
    public partial class ShipmentApi : IShipmentApi
    {
        ...
        /// <returns></returns>
        public ShipmentApi(shippingapi.Client.Configuration configuration = null)
        {
        ...
        public ApiResponse<CancelShipment> CancelShipmentWithHttpInfo (string xPBTransactionId, string shipmentId, bool? xPBUnifiedErrorStructure = default(bool?), string xPBShipperCarrierAccountId = default(string), string cancelInitiator = default(string), Carrier? carrier = default(Carrier?))
        {
            ...
            string requestUrl = $"DELETE {localVarPath}?" + string.Join("&", localVarQueryParams.Select(kvp => $"{kvp.Key}={kvp.Value}").ToList());
            ...
            {
                ApiException exception = ExceptionFactory("CancelShipment", localVarResponse);
                if (exception != null)
                {
        ...
        public ApiResponse<Shipment> CreateShipmentLabelWithHttpInfo (string xPBTransactionId, Shipment shipment, bool? xPBUnifiedErrorStructure = default(bool?), string xPBIntegratorCarrierId = default(string), string xPBShipperRatePlan = default(string), string xPBShipmentGroupId = default(string), string xPBShipperCarrierAccountId = default(string), string includeDeliveryCommitment = default(string))
        {
            ...
            if (ExceptionFactory != null)
            {
                ApiException exception = ExceptionFactory("CreateShipmentLabel", localVarResponse);
                if (exception != null)
                {
                    exception.RequestUrl = requestUrl;
                    exception.RequestHeaders = requestHeaders;
