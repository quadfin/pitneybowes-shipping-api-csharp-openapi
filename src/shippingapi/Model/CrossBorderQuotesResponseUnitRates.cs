...
namespace shippingapi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CrossBorderQuotesResponseUnitRates :  IEquatable<CrossBorderQuotesResponseUnitRates>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CrossBorderQuotesResponseUnitRates" /> class.
        /// </summary>
        ...
        public CrossBorderQuotesResponseUnitRates(decimal unitPrice = default(decimal), decimal totalTaxAmount = default(decimal), int totalDutyAmount = default(int), string serviceId = default(string), decimal baseCharge = default(decimal), CrossBorderQuotesResponseUnitRatesDeliveryCommitment deliveryCommitment = default(CrossBorderQuotesResponseUnitRatesDeliveryCommitment), decimal totalCarrierCharge = default(decimal))
        {
        ...
        {
            return this.Equals(input as CrossBorderQuotesResponseUnitRates);
        }

        /// <summary>
        /// Returns true if CrossBorderQuotesResponseUnitRates instances are equal
        /// </summary>
        /// <param name="input">Instance of CrossBorderQuotesResponseUnitRates to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CrossBorderQuotesResponseUnitRates input)
        {
            if (input == null)
                return false;
