...
namespace shippingapi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PageRealTransactionDetailReport :  IEquatable<PageRealTransactionDetailReport>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PageRealTransactionDetailReport" /> class.
        /// </summary>
        ...
        public PageRealTransactionDetailReport(List<RealTransactionDetailReport> content = default(List<RealTransactionDetailReport>), bool first = default(bool), bool last = default(bool), int number = default(int), int numberOfElements = default(int), int size = default(int), long totalElements = default(long), int totalPages = default(int), SearchCriteria searchCriteria = default(SearchCriteria))
        {
        ...
        public List<RealTransactionDetailReport> Content { get; set; }
        ...
        {
            return this.Equals(input as PageRealTransactionDetailReport);
        }

        /// <summary>
        /// Returns true if PageRealTransactionDetailReport instances are equal
        /// </summary>
        /// <param name="input">Instance of PageRealTransactionDetailReport to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageRealTransactionDetailReport input)
        {
            if (input == null)
                return false;
