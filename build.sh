...
${nuget_cmd} install src/shippingapi/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/shippingapi.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/shippingapi.dll \
-recurse:'src/shippingapi/*.cs' \
-doc:bin/shippingapi.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/shippingapi.dll was created successfully"
fi
